...
export namespace Action {
  ...
  export async function registerCompletionItemProvider(
    ...
    try {
      ...
      const vsPosition = Utils.mapToVirtualPosition(position, virtualUri.startPosition, virtualUri.offset);
      const pos = positionToOffset(virtualUri.content, vsPosition);
      console.log("Mapped position for completions:", { vsPosition, pos, url: virtualUri?.url.fsPath });
      ...
      console.log("Completions from TS Language Service:", completions);
